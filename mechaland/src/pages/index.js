    ...
    <div>
        ...
        <div className={styles.swiper}>
          ...
          {/* {load ?
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  ...
                  <div className={styles.bannerContent}>
                    ...
                    <a href={item.link} class="btn btn-lg active" role="button" aria-pressed="true" className={styles.bannerButton}>BUY NOW!</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="bannerShow" class="carousel slide" data-ride="carousel">
              <ol class="carousel-indicators">
                {hero.map((item, idx) =>
                  <li data-target="#bannerShow" data-slide-to={idx} class={idx == 0 ? "active" : ""}></li>
                )}
              </ol>
              <div class="carousel-inner">
                {hero.map((item, idx) =>
                  <div class={idx == 0 ? "carousel-item active" : "carousel-item"}>
                    ...
                    <div className={styles.bannerTitle}>
                      <h5>{item.text}</h5>
                      <a href={item.link} class="btn btn-lg active" role="button" aria-pressed="true">BUY NOW!</a>
                    </div>
                  </div>
                )}
              </div>
      ...
      <div className={styles.main}>
          ...
          <Row style={{ display: "flex", justifyContent: "center", alignItems: "center"}}>
            <Col sm="12" md="4" style={{ margin: "3vw 0" }}>
              <a href='https://www.tokopedia.com/mechaland' target="_blank" rel="noopener noreferrer">
                <img src="/assets/temp/switch1.png" alt="Mechaland Featured" className={styles.featuredPict} />
                <h5 className={styles.featured}>JWICK T1 Stem Switch (Tactile - PCB Mount)</h5>
              </a>
            </Col>
            <Col sm="12" md="4" style={{ margin: "3vw 0" }}>
              <a href='https://www.tokopedia.com/mechaland' target="_blank" rel="noopener noreferrer">
                <img src="/assets/temp/switch2.png" alt="Mechaland Featured" className={styles.featuredPict} />
                <h5 className={styles.featured}>JWICK Black Switch (Linear - PCB Mount) - 58.5g</h5>
              </a>
            </Col>
            <Col sm="12" md="4" style={{ margin: "3vw 0" }}>
              <a href='https://www.tokopedia.com/mechaland' target="_blank" rel="noopener noreferrer">
                <img src="/assets/temp/switch3.png" alt="Mechaland Featured" className={styles.featuredPict} />
        ...
        <div className={styles.sectionDiscord}>
          ...
          <p>so you won't miss anything!</p>
          <a href={'https://discord.gg/dGU2FyaUxd'} target="_blank" rel="noopener noreferrer" class="btn btn-lg active" role="button" aria-pressed="true" className={styles.discordButton}>
            <i class="bi bi-discord"/> JOIN OUR DISCORD
          </a>
          <a href={'https://discord.gg/dGU2FyaUxd'} target="_blank" rel="noopener noreferrer" class="btn btn-lg active" role="button" aria-pressed="true" className={styles.discordButton}>
            <i class="bi bi-discord"/>
            <span style="font-size:18px">JOIN OUR</span><br/>
            <span style="font-size:10px">DISCORD</span>
          </a>
          <a href="https://discord.gg/dGU2FyaUxd" target="_blank" rel="noopener noreferrer" class="btn btn-lg active" role="button" aria-pressed="true" className={styles.discordButton}>
            <Row>
              <Col sm="3">
              <img src="/assets/tokopedia.png" alt="Mechaland Tokopedia" width="48" height="48"/>
              </Col>
              <Col sm="9">
                <span style="font-size:14px">JOIN OUR</span><br/>
